...
7. Чтобы объединить ветви командой git merge. Слияние необходимо делать из той ветки, в которую нужно внести новую. Н-р: из ветки master набираем команду git merge *название ветки*;
